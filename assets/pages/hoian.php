...
<head>
    ...
    <title>Hoi An | Travel Website</title>
    ...
    <section class="about" id="about">
        <div class="container">
          ...
          <div data-aos="fade-up" data-aos-delay="450" class="content flex top">
            <div class="left">
              <h3 class="text-tour">Hoi An - Small pearl</h3>
              <p>With its long history of development, the residents living in Hoi An have gradually developed diverse occupations such as carpentry, fine art pottery, vegetable growing, medicine, lantern making.... to serve the needs of their life, at the same time also create prosperity and bustle for the port town of Hoi An from the 17th century to the end of the 18th century, the beginning of the 19th century. This is also one of the attractions that attract a lot of tourists. In 2011, the world famous online travel site Tripadvisor voted and announced the list of 10 most attractive culinary destinations in Asia, in which the traditional dishes of Hoi An were ranked 6th. According to the description of Tripadvisor, the famous traditional dishes of Hoi An such as Cao Lau, Quang noodles, deep fried pancakes, "white rose" cake are luxurious and attractive both in taste and presentation. , fascinates international tourists. Visitors who have not enjoyed the typical flavors of these dishes are considered as having never been to Hoi An.</p>
              <a href="">
                  <button class="flex1">
            ...
            <div class="right">
              <div class="video-container">
                <video src="../src/img/about-vid-4.mp4" muted autoplay loop class="video"></video>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="grid wide tour--card">
        ...
        <?php
            ...
            <div class="container--card l-4 m-6 c-12">
                <form method="post" action="hoian.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="card">
