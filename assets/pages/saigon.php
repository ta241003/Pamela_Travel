...
<head>
    ...
    <title>Sai Gon | Travel Website</title>
    ...
    <section class="about" id="about">
        <div class="container">
          ...
          <div data-aos="fade-up" data-aos-delay="450" class="content flex top">
            <div class="left">
              <h3 class="text-tour">Sai Gon - Pearl of the Far East</h3>
              <p>The tourist attractions of the city are relatively diverse. With a system of 11 museums, mainly on historical topics, Ho Chi Minh City ranks first in Vietnam in terms of the number of museums. The largest and oldest museum in the city is the Ho Chi Minh City History Museum with 30,000 artifacts. While the majority of visitors to the War Remnants Museum are foreigners, the museum that attracts the most domestic visitors is the Ho Chi Minh Museum. Ho Chi Minh City is also a religiously diverse metropolis. The city's largest and most famous church is the Notre-Dame Cathedral, located in District 1, completed in 1880. The colonial period has left the city with many important structures, such as the Headquarters of the People's Committee. City people, Opera House, Central Post Office, Nha Rong Wharf,... Independence Palace and General Science Library were built under the Republic of Vietnam. Modern architecture makes a mark in the city with buildings, hotels, and commercial centers such as Diamond Plaza, Saigon Trade Center... Outside the center area, Cu Chi Tunnels, Can Gio Mangrove Forest, Garden Thu Duc stork is also an important tourist destination.</p>
              <a href="">
                  <button class="flex1">
            ...
            <div class="right">
              <div class="video-container">
                <video src="../src/img/about-vid-3.mp4" muted autoplay loop class="video"></video>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="grid wide tour--card">
        ...
        <?php
            ...
            <div class="container--card l-4 m-6 c-12">
                <form method="post" action="saigon.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="card">
                                ...
                                <div class="about-container">
                                    ...
                                    <div class="card__details">
                                        <ul>
                                            ...
                                            <input name="quantity" type="number" min="1" class="form-control" placeholder="Enter Number Of People" required/>
