...
<head>
    ...
    <title>Hue | Travel Website</title>
    ...
    <section class="about" id="about">
        <div class="container">
          ...
          <div data-aos="fade-up" data-aos-delay="450" class="content flex top">
            <div class="left">
              <h3 class="text-tour">Hue - Dreamland</h3>
              <p>Hue has many historical sites that have been recognized by UNESCO as world heritages. Along the Perfume River from Hue are countless other monuments, including the tombs of several emperors, including Minh Mang, Khai Dinh and Tu Duc. One temple of Hue is Thien Mu Pagoda, the largest temple in Hue and the official symbol of the city. Several French buildings are located along the south bank of the Perfume River. Among them are Quoc Hoc School and Hai Ba Trung School, which are the oldest high schools in Vietnam, and Saigon Morin Hotel, one of the oldest hotels in Vietnam. In addition to the various tourist attractions in Hue, the city also provides a large tract of land for the demilitarized zone, located about 70 km (43 mi) north, for the installation of other combat equipment. such as The Rockpile, Khe Sanh Base or Vinh Moc Tunnels.</p>
              <a href="">
                  <button class="flex1">
            ...
            <div class="right">
              <div class="video-container">
                <video src="../src/img/about-vid-8.mp4" muted autoplay loop class="video"></video>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="grid wide tour--card">
        ...
        <?php
            ...
            <div class="container--card l-4 m-6 c-12">
                <form method="post" action="hue.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="card">
