...
if(isset($_POST["add_to_cart"]))
{
	if(isset($_SESSION["shopping_cart"]))
	{
		...
		if(!in_array($_GET["id"], $item_array_id))
		{
            ...
            // $_SESSION['message'] = "Tour Ticket Successfully";
            echo '<script>alert("Book Tour Successfully!")</script>';
            echo '<script>window.location="cart_tour.php"</script>';

		}
		else
		{
			echo '<script>alert("Tour Already Exists In Your Cart")</script>';
		}
	}
	else
	{
...
<head>
    ...
    <title>Ha Noi | Travel Website</title>
...
<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="e691aa10-6c50-4b81-a505-14e4be52ae3a";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
</head>
    ...
    <section class="about" id="about">
        <div class="container">
          ...
          <div data-aos="fade-up" data-aos-delay="450" class="content flex top">
            <div class="left">
              <h3 class="text-tour">Ha Noi Is Viet Nam's Capital</h3>
              ...
              <p>Hanoi is home to many important cultural, entertainment and sports sites of the country, and is also the place chosen to organize many international political and sports events. This is the place where many traditional craft villages are concentrated, and is also one of the three regions with many festivals of the North of Vietnam. Hanoi's cuisine with many distinctive features is also one of the factors attracting tourists to the city. The city was awarded the title of "City for Peace" by UNESCO on July 16, 1999. The Imperial Citadel of Thang Long is also recognized by UNESCO as a world cultural heritage.</p>
              <a href="">
                  <button class="flex1">
            ...
            <div class="right">
              <div class="video-container">
                <video src="../src/img/about-vid-5.mp4" muted autoplay loop class="video"></video>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="grid wide tour--card">
        ...
        <?php
            ...
            <div class="container--card l-4 m-6 c-12">
                <form method="post" action="hanoi.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="card">
                        ...
                        <div class="content-tour">
                            <div class="left">
                                ...
                                <button class="flex2" type="submit" name="add_to_cart" value="Add to Cart" id="success">
                                    <span>Book Now</span>
