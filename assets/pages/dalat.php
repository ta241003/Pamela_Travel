...
<head>
    ...
    <title>Da Lat | Travel Website</title>
...
<header class="header">
    ...
    <section class="about" id="about">
        <div class="container">
          ...
          <div data-aos="fade-up" data-aos-delay="450" class="content flex top">
            <div class="left">
              <h3 class="text-tour">Da Lat - City of Thousand Flowers</h3>
              <p>With an altitude of 1,500 meters above sea level and surrounded by mountain ranges and forest flora, Da Lat inherits a mild and cool mountainous climate all year round. The history of more than a century has also left the city a valuable architectural heritage, which is likened to a museum of European architecture in the twentieth century. The rich natural and human resources make Da Lat one of the famous tourist destinations of Vietnam, attracting millions of tourists every year to visit and relax. Da Lat is also a center of education and scientific research, a religiously diverse city with the presence of hundreds of pagodas, churches, monasteries... a particularly rich agricultural region with vegetable and flower products. Thanks to its mild climate, beautiful natural landscape and rich architectural heritage, Da Lat is also known by many other names such as "Misty City", "City of Thousand Pines", "City of Thousands of Pines". flowers", "Land of Cherry Blossoms" or "Little Paris".</p>
              <a href="">
                  <button class="flex1">
            ...
            <div class="right">
              <div class="video-container">
                <video src="../src/img/about-vid-9.mp4" muted autoplay loop class="video"></video>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="grid wide tour--card">
        ...
        <?php
            ...
            <div class="container--card l-4 m-6 c-12">
                <form method="post" action="dalat.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="card">
    ...
    <div class="comment">
        ...
        <form action="" method="post">
            <input type="text" name="name" placeholder="Name" class="name-cmt">
        
            <textarea name="message" placeholder="Write The Message" class="message-cmt"></textarea>
