...
<head>
    ...
    <title>Admin | Comment from Customers</title>
</head>
<body>
    <nav>
        <div class="logo-name">
        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <i class="fa fa-rectangle-list"></i>
                    <span class="text">List of Comment from Customers</span>
                </div>
                ...
                <table class="table table-bordered activity-data">
                    <thead>
                        <tr>
                            <th class="data-title">ID Comment</th>
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $comment)
                                {
                                    ?>
                                    <tr>
                                        <td class="data-list"><?= $comment['id']; ?></td>
                                        <td class="data-list"><?= $comment['name']; ?></td>
                                        <td class="data-list"><?= $comment['message']; ?></td>
                                        <td class="data-list"><?= $comment['send_at']; ?></td>
                                        <td>
                                            <form action="comment_db.php" method="POST" class="d-inline">
                                                <button type="submit" name="delete_comment" value="<?=$comment['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
                                    <?php
