...
<head>
    ...
    <title>Nha Trang | Travel Website</title>
    ...
    <section class="about" id="about">
        <div class="container">
          ...
          <div data-aos="fade-up" data-aos-delay="450" class="content flex top">
            <div class="left">
              <h3 class="text-tour">Nha Trang - pearl of the East Sea</h3>
              <p>Nha Trang is one of the most important tourist hubs of Vietnam, thanks to its beaches with fine and clean sand and the clear ocean water with mild temperatures all year round. There are several resorts — such as Vinpearl, Diamond Bay and Ana Mandara — and amusement and water parks, in the city and on islands off the coast. The possibly most beautiful street of Nha Trang is Tran Phu Street along the seaside, sometimes referred to as the Pacific Coast Highway of Vietnam. Lying off Nha Trang is the Hon Tre Island (Bamboo Island), with a major resort operated by the Vinpearl Group. The Vinpearl Cable Car, a gondola lift system, links the mainland to the five-star resort and theme park on Hon Tre Island. Nha Trang is a stopover for annual yacht races starting in Hong Kong. In recent years, the city has welcomed many five-star sea cruises. In addition to sailboat racing, Nha Trang provides a rich variety of tourist activities for visitors. Island hopping, scuba diving, water sports and other sporting activities can be enjoyed.</p>
              <a href="">
                  <button class="flex1">
            ...
            <div class="right">
              <div class="video-container">
                <video src="../src/img/about-vid-2.mp4" muted autoplay loop class="video"></video>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="grid wide tour--card">
        ...
        <?php
            ...
            <div class="container--card l-4 m-6 c-12">
                <form method="post" action="nhatrang.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="card">
