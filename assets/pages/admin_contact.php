...
<head>
    ...
    <title>Admin | Contact Book of Customers</title>
</head>
<body>
    <nav>
        <div class="logo-name">
        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <i class="fa fa-rectangle-list"></i>
                    <span class="text">List of Contact Infomation from Customers</span>
                </div>

                <?php include('message.php'); ?>

                <div class="card-header" style="border-radius: 20px; margin-bottom: 1rem;">
                        <h4>List of Contact Infomation</h4>
                </div>

                <table class="table table-bordered activity-data">
                    <thead>
                        <tr>
                            <th class="data-title">ID Contact</th>
                            <th class="data-title">Customer Name</th>
                            <th class="data-title">Customer Email</th>
                            <th class="data-title">Subject</th>
                            <th class="data-title">Message</th>
                            <th class="data-title">Send At</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php 
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $contact)
                                {
                                    ?>
                                    <tr>
                                        <td class="data-list"><?= $contact['id']; ?></td>
                                        <td class="data-list"><?= $contact['name']; ?></td>
                                        <td class="data-list"><?= $contact['email']; ?></td>
                                        <td class="data-list"><?= $contact['subject']; ?></td>
                                        <td class="data-list"><?= $contact['message']; ?></td>
                                        <td class="data-list"><?= $contact['send_at']; ?></td>
                                        <td>
                                            <form action="contact_db.php" method="POST" class="d-inline">
