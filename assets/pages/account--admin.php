...
<head>
    ...
    <title>Admin | Manage Account Admins</title>
</head>
<body>
    <nav>
        <div class="logo-name">
        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <i class="fa fa-rectangle-list"></i>
                    <span class="text">List Of Account Admins</span>
                </div>

                <?php include('message.php'); ?>

                <div class="card-header" style="border-radius: 20px; margin-bottom: 1rem;">
                        <h4>Account Admins Details
                            <a href="admin-register--admin.php" class="btn btn-primary float-end">Add Account Admin</a>
                        </h4>
                </div>
                ...
                <table class="table table-bordered activity-data">
                    ...
                    <?php 
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $acc_admin)
                                {
                                    ?>
                                    <tr>
                                        <td class="data-list"><?=$acc_admin['id']; ?></td>
                                        <td class="data-list"><?=$acc_admin['admin']; ?></td>
                                        <td class="data-list"><?=$acc_admin['email']; ?></td>
                                        <td class="data-list"><?=$acc_admin['password']; ?></td>
                                        <td class="data-list"><?=$acc_admin['position']; ?></td>
